...
To spin up the sanctuary website locally, follow these steps:

1. Clone the repository:
   ```bash
   git clone [https://github.com/YOUR_USERNAME/luna-laguna.git](https://github.com/YOUR_USERNAME/luna-laguna.git)
